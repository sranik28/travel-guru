    ...
    return (
        <main className='absolute top-[70px] text-white flex h-[80vh] gap-6 items-center'>
            <div className='flex justify-center flex-col md:w-[30%] whitespace-nowrap'>
                ...
                <button className='bg-[#F9A51A] w-[40%]  h-[45px] mt-5 text-black font-semibold flex items-center justify-center gap-4 rounded'>Booking <span> <img src={BArrow} alt="" /></span></button>
            </div>
            <Slider />
        </main>
    );
